...
public class Batteria extends Componente implements Ruotabile {
	...
	@Override // controllo se si puo' posizionare il componente, viene controllato anche che
				// un eventuale componente adiacente abbia un connettore
	...
	public void rotate() {
		...
		Connettori last = this.getConnettori()[3]; // prende l'ultimo connettore per settarlo alla prima posizione nel
													// return
